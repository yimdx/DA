from diffgd.constants import DATASET_ROOT
from diffgd.data import BaseData, GraphDrawingData
...
class RomeDataset(pyg.data.InMemoryDataset):
    ...
    DEFAULT_NAME = "Rome"
    DEFAULT_URL = "https://www.graphdrawing.org/data/rome-graphml.tgz"
